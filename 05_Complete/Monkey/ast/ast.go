...
// struct to hold the value of expression or parse identifier expression
...
// struct for boolean literal expression
type Boolean struct {
	Token token.Token
	Value bool
}
...
// struct for string literal expression
...
// struct for array index operator expression
